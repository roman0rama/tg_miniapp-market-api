...
var ProductsController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, db_js_1.pool.query('INSERT INTO categories ( image, title ) VALUES ($1, $2) RETURNING *', [req.body.name, req.body.cost])];
                    case 1:
                        review = _a.sent();
                        res.json(review);
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, db_js_1.pool.query('DELETE FROM categories WHERE id = $1', [req.body.id])];
                    case 1:
                        review = _a.sent();
    ...
    ProductsController.getProducts = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var products, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, db_js_1.pool.query('SELECT * FROM cards')];
                    case 1:
                        products = _a.sent();
